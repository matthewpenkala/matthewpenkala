    ...
    if (navigator.platform.toLowerCase().includes('mac') || (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream)) {
        ...
        if (window.innerWidth > 991) {
            ...
            (function () {
                ...
                style.textContent = `#PROJ-NAV .project-pagination-center *,.button-inner,.footer-left-grid .text-meta,.project-about-client-grid div>.text-meta,.text-meta:not(.text-color-muted,.project-meta-item *),.text-rich-text,.w-richtext *,h3.heading-h6{-webkit-font-smoothing:subpixel-antialiased!important;text-rendering:auto;}`;
        ...
        (function () {
            var style = document.createElement('style');
            style.textContent = `#PROJ-NAV{opacity:100%!important;filter:none!important;backdrop-filter:none!important;background:#014d90!important;}`;
            document.head.appendChild(style);
        })();

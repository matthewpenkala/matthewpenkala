            ...
            elements.forEach((e) => {
                ...
                if (e.isIntersecting === true) {
                    ...
                    if (this_data_logo !== '0') {
						...
						anchorElement.setAttribute("onclick", "event.preventDefault(); var otherWindow = window.open(); otherWindow.opener = null; otherWindow.location = this.href; return false; event.stopPropagation();");
						...
						this_logo.setAttribute("onclick", "event.preventDefault(); var otherWindow = window.open(); otherWindow.opener = null; otherWindow.location = this.href; return false; event.stopPropagation();");

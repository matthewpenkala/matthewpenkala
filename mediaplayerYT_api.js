...
if(!window.YT)var YT={loading:0,loaded:0};if(!window.YTConfig)var YTConfig={host:"https://web.archive.org/web/20190128231754/https://www.youtube.com"};YT.loading||(YT.loading=1,function(){var o=[];YT.ready=function(n){YT.loaded?n():o.push(n)},window.onYTReady=function(){YT.loaded=1;for(var n=0;n<o.length;n++)try{o[n]()}catch(i){}},YT.setConfig=function(o){for(var n in o)o.hasOwnProperty(n)&&(YTConfig[n]=o[n])}}());
...
g.C=function(a){a.id=this.g;a.channel="widget";a=Ga(a);var b=this.b;var c=Oa(this.a.src);b=0==c.indexOf("https:")?[c]:b.a?[c.replace("http:","https:")]:b.c?[c]:[c,c.replace("http:","https:")];if(!this.a.contentWindow)throw Error("The YouTube player is not attached to the DOM.");for(c=0;c<b.length;c++)try{
	//skip first post message for SHUT UP : Failed to execute 'postMessage' on 'DOMWindow': The target origin provided ('https://web.archive.org/web/20190128231754/https://www.youtube.com') does not match the recipient window's origin
	if(this._skiped){
...
/*
     FILE ARCHIVED ON 23:17:54 Jan 28, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:30:36 Nov 16, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.057
  esindex: 0.009
  LoadShardBlock: 64.002 (3)
  PetaboxLoader3.datanode: 86.218 (4)
  load_resource: 143.722
  PetaboxLoader3.resolve: 97.955
*/

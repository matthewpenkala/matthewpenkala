...
YT.loading || (YT.loading = 1, function () {
    ...
    YT.setConfig = function (o) {
        for (var n in o)
            o.hasOwnProperty(n) && (YTConfig[n] = o[n]);
    };
}());

// https://s.ytimg.com/yts/jsbin/www-widgetapi-vfluxKqfs/www-widgetapi.js
// (MODIFIED) - ELIMINATED ATTR allowfullscreen, title like "YouTube video player"
(function () {
    var g, k = this;
    function l(a) {
    ...
    var r = 'closure_uid_' + (1000000000 * Math.random() >>> 0), t = 0;
    function ba(a, b, c) {
    ...
    function Ua(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = 'ERRORS' in O ? O.ERRORS : c, c.push([
            a,
            b,
            void 0,
            void 0,
    ...
    function W(a, b, c) {
        ...
        if (a = l(a) ? c.getElementById(a) : a)
            if (c = 'iframe' == a.tagName.toLowerCase(), b.host || (b.host = c ? Oa(a.src) : 'https://www.youtube.com'), this.b = new hb(b), c || (b = jb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), a.allowFullscreen = false, // MODIFICAT!!!
                this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++t), b.id = 'widget' + a), Q[this.a.id] = this, window.postMessage) {
                this.f = new K();
                kb(this);
                b = V(this.b, 'events');
                for (var d in b)
    ...
    function jb(a, b) {
        ...
        c.setAttribute('allow', 'encrypted-media; autoplay');
    ...
    g.C = function (a) {
        ...
        var b = this.b;
        var c = Oa(this.a.src);
        b = 0 == c.indexOf('https:') ? [c] : b.a ? [c.replace('http:', 'https:')] : b.c ? [c] : [
            c,
        ...
        y(b, function (a) {
            this[a] || ('getCurrentTime' == a ? this[a] = function () {
                ...
                if (1 == this.j.playerState) {
                    var b = (ea() / 1000 - this.j.currentTimeLastUpdated_) * this.j.playbackRate;
                    0 < b && (a += Math.min(b, 1));
                }
                return a;
    ...
    g.P = function () {
        ...
        qa.test(c) && (-1 != c.indexOf('&') && (c = c.replace(ka, '&amp;')), -1 != c.indexOf('<') && (c = c.replace(la, '&lt;')), -1 != c.indexOf('>') && (c = c.replace(ma, '&gt;')), -1 != c.indexOf('"') && (c = c.replace(na, '&quot;')), -1 != c.indexOf("'") && (c = c.replace(oa, '&#39;')), -1 != c.indexOf('\0') && (c = c.replace(pa, '&#0;')));
        a = '<iframe width="' + a + '" height="' + b + '" src="' + c + '" frameborder="0" allow="encrypted-media; autoplay" data-test=1></iframe>';
        return a;
    };
    g.O = function (a) {

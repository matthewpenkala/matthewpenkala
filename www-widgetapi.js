(function () {
    ...
    if (c) {
      ...
      if (this.o) for (e = 0; e < c.length; e++) {
        ...
        try {
          ...
          if (this.h--, 0 < this.g.length && 0 == this.h) for (; c = this.g.pop();) this.D(c);
        }
      }
      return 0 != e;
    }
  ...
  function Pa(a, b, c) {
    if ("array" == n(b)) for (var d = 0; d < b.length; d++) Pa(a, String(b[d]), c);else null != b && c.push(a + ("" === b ? "" : "=" + encodeURIComponent(String(b))));
  }
  function Qa(a) {
    var b = [],
      c;
  ...
  function W(a, b, c) {
    ...
    this.o = {};
    c = document;
    if (a = l(a) ? c.getElementById(a) : a) if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? Oa(a.src) : "https://www.youtube.com"), this.b = new hb(b), c || (b = jb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++t), b.id = "widget" + a), Q[this.a.id] = this, window.postMessage) {
      this.f = new K();
      kb(this);
      b = V(this.b, "events");
  ...
  g.C = function (a) {
    ...
    for (c = 0; c < b.length; c++) try {
      ...
      if (d.name && "SyntaxError" == d.name) Ua(d, "WARNING");else throw d;
    }
  };
  Ka(new La());
  Ka(new Ma());
